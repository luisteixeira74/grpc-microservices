...
const file_random_proto_rawDesc = "" +
	"\n" +
	"\frandom.proto\x12\x06random\"\x0f\n" +
	"\rRandomRequest\"$\n" +
	"\x0eRandomResponse\x12\x12\n" +
	"\x04word\x18\x01 \x01(\tR\x04word2S\n" +
	"\rRandomService\x12B\n" +
	"\x0fGetRandomStream\x12\x15.random.RandomRequest\x1a\x16.random.RandomResponse0\x01B:Z8github.com/luisteixeira74/grpc-microservices/proto;protob\x06proto3"
